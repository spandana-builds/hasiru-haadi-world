      ...
      <div className="village-page">
        ...
        <FadeIn>
          <section className="village-hero">
            <div className="hero-img-wrap">
              <img loading="lazy" src={heroImg} alt="Yerigenahalli village at dusk" />
              <div className="hero-overlay">
                <h1>Yerigenahalli</h1>
                <p>Where life moves with the land, light, and people.</p>
              </div>
            </div>
          </section>
        </FadeIn>
        ...
        <FadeIn delay={0.05}>
          <section className="village-story">
            <p><strong>Yerigenahalli</strong> is one of the most beautiful villages I have ever seen.</p>
            <p>
        ...
        {/* Village Moments */}
        <FadeIn delay={0.05}>
          <section className="village-photos">
            <h2>Village Moments</h2>
            <div className="photo-grid">
              <img loading="lazy" src={field1}    alt="Cultivated crop fields" />
              <img loading="lazy" src={field2}    alt="Farming work and tractor" />
              <img loading="lazy" src={lifeImg}   alt="Cows and calves in the village" />
              <img loading="lazy" src={skyImg}    alt="Village sunset sky" />
              <img loading="lazy" src={detailImg} alt="Quiet village water body" />
            </div>
          </section>
        </FadeIn>

        <ExploreMore current="/village" />
