  ...
  return (
    <PageWrapper>
      <div className="plants-page">
        ...
        <FadeIn>
          <section className="plants-hero">
            <div className="hero-img-wrap">
              <img loading="lazy" src={heroImg} alt="Potted plants" />
              <div className="hero-overlay">
                <h1>My Plants</h1>
                <p>Where curiosity slowly turned into companionship.</p>
              </div>
            </div>
          </section>
        </FadeIn>
        ...
        {/* Story */}
        <FadeIn delay={0.05}>
          <section className="plants-story">
            ...
            <p className="plants-signature">
              Plants taught me patience, observation, and how small care can create something beautiful.
            </p>
          </section>
        </FadeIn>
        ...
        {/* Plant Moments */}
        <FadeIn delay={0.05}>
          <section className="plants-photos">
            <h2>Plant Moments</h2>
            <div className="photo-grid">
              <img loading="lazy" src={plant1} alt="Young plant growth" />
              <img loading="lazy" src={plant2} alt="New leaves emerging" />
              <img loading="lazy" src={plant3} alt="Healthy potted plant" />
              <img loading="lazy" src={plant4} alt="Plant collection at home" />
              <img loading="lazy" src={plant5} alt="Plant collection at home" />
              <img loading="lazy" src={plant6} alt="Plant collection at home" />
              <img loading="lazy" src={plant7} alt="Plant collection at home" />
              <img loading="lazy" src={plant8} alt="Plant collection at home" />
              <img loading="lazy" src={plant9} alt="Plant collection at home" />
            </div>
          </section>
        </FadeIn>
