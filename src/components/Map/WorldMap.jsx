  ...
  return (
    <PageWrapper>
      <div className="world-map">
        ...
        <svg className="map-path" viewBox="0 0 1200 300" preserveAspectRatio="none">
          <path
            d="M -100 160 C 150 100, 300 220, 450 160 C 600 100, 760 220, 900 160 C 1050 110, 1200 180, 1350 150"
            fill="none" stroke="#a07055" strokeWidth="20" strokeLinecap="round"
          />
          <path
            d="M -100 160 C 150 100, 300 220, 450 160 C 600 100, 760 220, 900 160 C 1050 110, 1200 180, 1350 150"
